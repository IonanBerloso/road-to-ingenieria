...
|---|---|---|---|
| `reconocer` | elegir el concepto antes de calcular | COMP1 | 1.853 |
| `calcular` | introducir el resultado y recibir el diagnóstico | COMP2 | 3.872 |
| `justificar` | ordenar las piezas, con una trampa | COMP4 | 1.753 |
