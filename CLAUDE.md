...
|---|---|---|---|
| `reconocer` | elegir el concepto antes de calcular | COMP1 | 1.965 |
| `calcular` | introducir el resultado y recibir el diagnóstico | COMP2 | 4.064 |
| `justificar` | ordenar las piezas, con una trampa | COMP4 | 1.856 |
