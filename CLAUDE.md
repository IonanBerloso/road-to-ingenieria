...
|---|---|---|---|
| `reconocer` | elegir el concepto antes de calcular | COMP1 | 1.975 |
| `calcular` | introducir el resultado y recibir el diagnóstico | COMP2 | 4.084 |
| `justificar` | ordenar las piezas, con una trampa | COMP4 | 1.866 |
