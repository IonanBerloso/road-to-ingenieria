...
|---|---|---|---|
| `reconocer` | elegir el concepto antes de calcular | COMP1 | 1.955 |
| `calcular` | introducir el resultado y recibir el diagnóstico | COMP2 | 4.044 |
| `justificar` | ordenar las piezas, con una trampa | COMP4 | 1.846 |
