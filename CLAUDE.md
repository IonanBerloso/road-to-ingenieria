...
|---|---|---|---|
| `reconocer` | elegir el concepto antes de calcular | COMP1 | 1.995 |
| `calcular` | introducir el resultado y recibir el diagnóstico | COMP2 | 4.117 |
| `justificar` | ordenar las piezas, con una trampa | COMP4 | 1.886 |
