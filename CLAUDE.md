...
|---|---|---|---|
| `reconocer` | elegir el concepto antes de calcular | COMP1 | 1.836 |
| `calcular` | introducir el resultado y recibir el diagnóstico | COMP2 | 3.857 |
| `justificar` | ordenar las piezas, con una trampa | COMP4 | 1.744 |
