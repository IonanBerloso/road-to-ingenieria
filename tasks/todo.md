...
| corpus | **1.304 ejercicios · 5.314 pasos** |
...
**Las diecisiete comparables, todas** leídas el 9 de septiembre de 2026, mirando siempre el final primero:
...
| **enero 2021** | **segundo ejercicio repetido palabra por palabra**: sus tubos concéntricos son el ejercicio 3 del 30-ene-2024, con la misma tabla de datos · los tres ejercicios **encadenados**: el 2 usa el 1 y el 3 usa el 2 · 3,5 h |
...
| **junio 2018** | la última · **un ciclo completo de tres politrópicas** con nitrógeno, único en las diecisiete · fachada de dos capas · «se valorará especialmente» deducir los signos antes de calcular · y la segunda convocatoria ese año fue **en junio**, no en enero |
...
## Los 90 ejercicios mal etiquetados, resueltos
...
- **Los diez temas escritos**, en un día: el bloque de Moran y Shapiro —temas
  1 a 7— y el de Çengel —8, 9 y 10—. **Treinta y cuatro ejercicios**, y veinte de
...
3. ~~Ejercicios de examen en `fuera`~~ · **cero, el 5 de septiembre de 2026.**
   **Las seis convocatorias de Química están transcritas enteras**, 27
   ...
   dejarse ninguno declarado.

   Los siete que hubo se escribieron esa tarde: el ciclo P-V de 2024-2025-2c
   —con su figura redibujada en SVG—, la hidracina, los cinco signos de
...
5. ~~El lector de respuestas químicas~~ · **hecho el 5 de septiembre de 2026.**
   Existe como `respuesta.tipo: formula`, en `lib/quimica.ts`, con 36 casos en
   `tests/quimica.test.ts` sacados de los veinte compuestos del corpus. Con él
   entran los dos ejercicios que faltaban y **las seis convocatorias de Química
   quedan transcritas enteras, sin un solo `fuera`.**

   Sabe comparar una fórmula normalizada, aceptar los dos nombres válidos de un
