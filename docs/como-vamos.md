...
**Nueve de las once ordinarias están hechas, y los temas 10 y 11 ya tienen
corpus con el que trabajar.** Van 74 convocatorias de 89 y 308 ejercicios de
examen. Laplace llega a **diez** ejercicios y Fourier a **nueve**. Faltan 15
convocatorias: dos ordinarias, once extraordinarias y los dos parciales de
2019-2020.
...
|---|---|---|---|---|---|
| t01 complejos | 2 885 | 3 | 37 | 8 | **60** |
| t02 sucesiones | 2 035 | 3 | 19 | 4 | 31 |
| t03 funciones reales | 1 779 | 3 | 23 | 5 | 21 |
| t04 estudio local | 2 036 | 3 | 18 | 5 | **61** |
| t05 integración | 1 925 | 4 | 30 | 4 | 33 |
| t06 varias variables | 1 797 | 2 | 12 | 4 | 17 |
| t07 integral múltiple | 1 422 | 2 | 10 | 3 | 28 |
| t08 integral curvilínea | 1 119 | 1 | 7 | 2 | 16 |
| t09 ecuaciones diferenciales | 1 241 | 1 | 7 | 2 | 22 |
| t10 Laplace | 872 | 1 | 8 | 2 | **10** |
| t11 Fourier | 888 | 1 | 8 | 2 | **9** |
| **total** | **17 999** | **24** | **179** | **41** | **308** |

En todo el corpus: **487 ejercicios y 1 868 pasos**.
...
enunciados y las resoluciones de examen van aparte, y en estas seis ordinarias
han sido veintinueve: seis en 2022-2023, cuatro en 2021-2022, cinco en
2020-2021, tres en 2018-2019, cinco en 2017-2018 y seis en 2016-2017.
Veintidós de las veintinueve **son nuestras**, y dieciocho viven en la
**resolución** y no en el enunciado: son los apartados donde el propio examen
dice «dibujar» o «representar», y ahí la figura no ilustra la respuesta — es la
respuesta.
...
byte a byte contra el original. Lo que falta es transcribir 15.

Sobre los 3 085 puntos repartidos de los 74 exámenes: **COMP1 9,3 % · COMP2
...
46,8 % sobre 66, 43,6 % sobre 73— y hoy **sube** por primera vez, porque la
ordinaria de 2016-2017 trae dos ejercicios con COMP2 = 0: el valor intermedio
y las curvas de nivel se resuelven razonando, sin calcular nada— y el motivo es estable: las convocatorias
...
La de la ordinaria dice estar medida sobre 2 convocatorias y ya hay 9
...
| **todas las convocatorias publicadas transcritas** | ❌ **74 de 89** |

> El «74 de 89» merece explicación: 85 son los PDF y 89 las convocatorias que
> contienen, porque cuatro cuadernillos traen dos exámenes dentro. De las 15
...
## Lo siguiente: las dos ordinarias que faltan
...
Lo aprendido en estas seis ordinarias, que conviene no volver a tropezar:
...
|---|---|---|
| 1 | **2 ordinarias** (faltan 2015-2016 y 2013-2014) | los temas 10 y 11, y la ruta `ord` |
...
- **26** — las 15 convocatorias globales que faltan. Es el plan de arriba.
...
- **33** — la ruta `ord` dice «medida sobre 2» con nueve ordinarias hechas.
...
- **35** — **los profesores repiten ejercicios entre convocatorias.** Medido
  sobre los 308: cuatro problemas aparecen diez veces, y el cuarto ha salido
