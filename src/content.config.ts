...
export const CONVOCATORIAS = {
  primera: { url: '1ev', corta: '1.ª ev.', boton: '1.ª evaluación', larga: 'primera evaluación' },
  segunda: { url: '2ev', corta: '2.ª ev.', boton: '2.ª evaluación', larga: 'segunda evaluación' },
  tercera: { url: '3ev', corta: '3.ª ev.', boton: '3.ª evaluación', larga: 'tercera evaluación' },
  'recuperacion-cuarta': {
    url: '4ev-rec',
    corta: 'recup. 4.ª',
    boton: 'Recup. 4.ª',
  ...
  cuarta: { url: '4ev', corta: '4.ª ev.', boton: '4.ª evaluación', larga: 'cuarta evaluación' },
  'recuperacion-quinta': {
    url: '5ev-rec',
    corta: 'recup. 5.ª',
    boton: 'Recup. 5.ª',
  ...
  quinta: { url: '5ev', corta: '5.ª ev.', boton: '5.ª evaluación', larga: 'quinta evaluación' },
  'primer-parcial': {
    url: '1par',
    corta: '1.er parc.',
    boton: '1.er parcial',
    larga: 'primer examen parcial',
  },
  'segundo-parcial': {
    url: '2par',
    corta: '2.º parc.',
    boton: '2.º parcial',
    larga: 'segundo examen parcial',
  },
  'tercer-parcial': {
    url: '3par',
    corta: '3.er parc.',
    boton: '3.er parcial',
    larga: 'tercer examen parcial',
  },
  'control-primer-cuatrimestre': {
    url: '1c-control',
    corta: 'control 1.er c.',
    boton: 'Control 1.er cuatr.',
    larga: 'control del primer cuatrimestre',
  },
  'primer-cuatrimestre': {
    url: '1c',
    corta: 'final 1.er c.',
    boton: 'Final 1.er cuatr.',
    larga: 'examen final del primer cuatrimestre',
  },
  'control-segundo-cuatrimestre': {
    url: '2c-control',
    corta: 'control 2.º c.',
    boton: 'Control 2.º cuatr.',
    larga: 'control del segundo cuatrimestre',
  },
  'segundo-cuatrimestre': {
    url: '2c',
    corta: 'final 2.º c.',
    boton: 'Final 2.º cuatr.',
    larga: 'examen final del segundo cuatrimestre',
  },
  ordinaria: { url: 'ord', corta: 'ordinaria', boton: 'Ordinaria', larga: 'convocatoria ordinaria' },
  extraordinaria: {
    url: 'ext',
    corta: 'extraord.',
    boton: 'Extraordinaria',
    larga: 'convocatoria extraordinaria',
  },
